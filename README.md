...
<video src="https://github.com/joeymiles/TrafficWatch/releases/download/demo-v1/demo.webm" controls muted playsinline width="100%"></video>

If the embed does not play: [demo.webm](docs/readme/demo.webm) · [demo.gif](docs/readme/demo.gif)
